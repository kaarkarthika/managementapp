        ...
        <div class=" ">
            <div class=" box-header with-border box-header-bg">
                ...
                <div class="pull-right">
                    <?= Html::a('Add New Family', ['create'], ['class' => 'btn btn-success']) ?>      
...
<script type="text/javascript">
    ...
    $(function () {
        $("#familymastersearch-createdat").datepicker({ 
            autoclose: true, 
           todayHighlight: true,
            format:'dd-mm-yyyy'
        });$("#familymastersearch-updatedat").datepicker({ 
            autoclose: true, 
           todayHighlight: true,
            format:'dd-mm-yyyy'
        });
