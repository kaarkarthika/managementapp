...
<div class="donation-type-master-form">
    <div id="page-content">
        <div class="">
            <div class="eq-height">
                <div class="panel">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class='col-sm-6 form-group' >
                                <?= $form->field($model, 'desigantionName')->textInput(['maxlength' => true,'class'=>'upper form-control']) ?>
                            </div>
                            <div class='col-sm-6 form-group' >
                                <?= $form->field($model, 'comments')->textarea(['maxlength' => true,'class'=>'form-control']) ?>
                            </div>
                            <?php 
