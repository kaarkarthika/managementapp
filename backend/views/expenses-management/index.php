...
$this->title = 'Expenses Management';
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function($models,$key){
                        $ds = date('d-m-Y',strtotime($models->exe_date));
                        if(strpos($ds, '1970')||strpos($ds, '0000')){
                            $ds = "-";
                        }
                        return $ds;
                    },
...
<script type="text/javascript">
    ...
    $(function () {
        $("#expensesmanagementsearch-created_at").datepicker({ 
            autoclose: true, 
           todayHighlight: true,
            format:'dd-mm-yyyy'
        });$("#expensesmanagementsearch-updated_at").datepicker({ 
            autoclose: true, 
           todayHighlight: true,
            format:'dd-mm-yyyy'
        });
