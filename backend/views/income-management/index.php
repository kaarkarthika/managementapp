            ...
            'columns' => [
                ...
                [
                    ...
                    'value'=>function($models, $keys){
                        $dt = date('d-m-Y',strtotime($models->income_date));
                ...
                [
                    ...
                    'value'=>function($models, $keys){
                        $name = "-";
                        if($models->payer_name!="" && $models->payer_name!=NULL){
                            $name = ucfirst($models->payer_name);
                        }
                        return $name;
                    },
                ],
...
<script type="text/javascript">
    ...
    $(function () {
        $("#incomemanagementsearch-created_at").datepicker({ 
            autoclose: true, 
           todayHighlight: true,
            format:'dd-mm-yyyy'
        });
        $("#incomemanagementsearch-updated_at").datepicker({ 
            autoclose: true, 
           todayHighlight: true,
            format:'dd-mm-yyyy'
        });
