...
<div class="commitee-management-index">
    ...
    <div class="box box-primary  ">
      <div class=" ">
        ...
        <div class="" id="searchDiv" style="margin-top: 25px;">
                    <?php echo $this->render('_search', ['model' => $searchModel]); ?>
                </div>
                <div class=" pull-right">
                    <?= Html::a('Add Commitee/Staff', ['create'], ['class' => 'btn btn-success']) ?>      
...
<script type="text/javascript">
     $('body').on("click",".modalView",function(){
             ...
             $('#operationalheader').html('<span> <i class="fa fa-fw fa-th-large"></i>Commitee Management</span>');
    ...
    $(function () {
        $("#commiteemanagementsearch-created_at").datepicker({ 
            autoclose: true, 
           todayHighlight: true,
            format:'dd-mm-yyyy'
        });$("#commiteemanagementsearch-updated_at").datepicker({ 
            autoclose: true, 
           todayHighlight: true,
            format:'dd-mm-yyyy'
        });
