...
$this->title = 'Income Modes Master';
...
<div class="donation-type-master-index">
   ...
   <?= Html::a('Add Income Mode', ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </div>
    </div>
...
<script type="text/javascript">
     $('body').on("click",".modalView",function(){
             ...
             $('#operationalheader').html('<span> <i class="fa fa-fw fa-th-large"></i>Donation Type</span>');
